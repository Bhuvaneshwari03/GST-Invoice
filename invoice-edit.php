		...
		<form method="post" id="update_invoice">
					...
					<?php 
						...
						if($result2) {
							while ($rows = mysqli_fetch_assoc($result2)) {
							    ...
							    $item_gst = $rows['invoice_gst'];
							    $item_gstamt = $rows['invoice_gstamt'];
					?>
					<tr>
						<td>
						...
						<td class="text-right">
							<div class="form-group form-group-sm  no-margin-bottom">
								<input type="number" class="form-control calculate invoice_gst" name="invoice_gst[]" id="invoice_gst[]" placeholder="Enter Gst Value" value="<?php echo $item_gst; ?>">
							</div>
						</td>
						<td class="text-right" style="display: none;">
							<div class="form-group form-group-sm  no-margin-bottom">
								<input type="text" class="form-control invoice_gstamt" name="invoice_gstamt[]" id="invoice_gstamt[]" placeholder="Enter Gst Value" value="<?php echo $item_gstamt; ?>">
							</div>
						</td>
						<td class="text-right" style="display: none;">
							<div class="form-group form-group-sm  no-margin-bottom">
			...
			<div class="row">
				<div class="col-xs-12 margin-top btn-group">
					<a href="invoice-list.php" class="btn btn-success float-left">Back</a>
