			...
			<table class="table table-bordered table-hover table-striped" id="invoice_table">
				...
				<tbody>
					<tr>
						...
						<td class="text-right">
							<div class="form-group form-group-sm  no-margin-bottom">
								<input type="number" class="form-control calculate invoice_gst" name="invoice_gst[]" id="invoice_gst[]" placeholder="Enter Gst%" value="0">
							</div>
						</td>
						<td class="text-right" style="display: none;">
							<div class="form-group form-group-sm  no-margin-bottom">
								<input type="text" class="form-control invoice_gstamt calculate" name="invoice_gstamt[]" id="invoice_gstamt[]"  placeholder="Enter GST%" value="0">
							</div>
						</td>
						<td class="text-right" style="display: none;">
							<div class="form-group form-group-sm  no-margin-bottom">
						...
						<td class="text-right">
							<div class="input-group input-group-sm">
								<span class="input-group-addon">₹</span>
								<input type="text" class="form-control calculate calculate-sub" name="invoice_product_sub[]" id="invoice_product_sub" value="0.00" aria-describedby="sizing-addon1" disabled>
							</div>
						</td>
					</tr>
				</tbody>
			...
			<div id="invoice_totals" class="padding-right row text-right">
				...
				<div class="col-xs-6 no-padding-right">
					<div class="row">
						...
						<div class="col-xs-3">
							<span>₹</span><span class="invoice-sub-total">0.00</span>
					...
					<div class="row" style="display: none;">
						...
						<div class="col-xs-3">
							<span>₹</span><span class="invoice-discount">0.00</span>
					...
					<div class="row" style="display: none;">
						...
						<div class="col-xs-3">
							<div class="input-group input-group-sm">
								<span class="input-group-addon">₹</span>
								<input type="text" class="form-control calculate shipping" name="invoice_shipping" aria-describedby="sizing-addon1" placeholder="0.00" value="0">
							</div>
						</div>
					</div>
					...
					<div class="row" style="display: none;">
						<div class="col-xs-4 col-xs-offset-5">
							<strong>TAX/GST:</strong><br>Remove TAX/GST <input type="checkbox" class="remove_vat" checked>
						</div>
						<div class="col-xs-3">
							<span>₹</span><span class="invoice-vat" data-enable-vat="<?php echo ENABLE_VAT ?>" data-vat-rate="<?php echo VAT_RATE ?>" data-vat-method="<?php echo VAT_INCLUDED ?>">0.00</span>
					...
					<div class="row">
						...
						<div class="col-xs-3">
							<span>₹</span><span class="invoice-gstamount">0.00</span>
							<input type="hidden" name="invoice_gstamount" id="invoice_gstamount">
						</div>
					</div>
					<div class="row">
						<div class="col-xs-4 col-xs-offset-5">
						...
						<div class="col-xs-3">
							<span></span><span class="round-off">0.00</span>
					...
					<div class="row">
						...
						<div class="col-xs-3">
							<span>₹</span><span class="invoice-total">0.00</span>
