...
<form method="post" id="update_customer">
					...
					<div class="row">
						<div class="col-xs-6">
							<div class="form-group">
								<input type="text" class="form-control margin-bottom copy-input required" name="customer_name" id="customer_name" placeholder="Enter name" tabindex="1" oninput="capitalizeInput('customer_name')" value="<?php echo $customer_name; ?>">
							</div>
							<div class="form-group">
								<input type="text" class="form-control margin-bottom copy-input required" name="customer_address_1" id="customer_address_1" placeholder="Address 1" tabindex="3" oninput="capitalizeInput('customer_address_1')" value="<?php echo $customer_address_1; ?>">	
							</div>
							<div class="form-group">
								<input type="text" class="form-control margin-bottom copy-input required" name="customer_town" id="customer_town" placeholder="Town" tabindex="5" oninput="capitalizeInput('customer_town')" value="<?php echo $customer_town; ?>">		
							</div>
							<div class="form-group no-margin-bottom">
								<input type="text" class="form-control copy-input required" name="customer_postcode" id="customer_postcode" placeholder="GST IN" tabindex="7" value="<?php echo $customer_postcode; ?>">					
							</div>
						</div>
						<div class="col-xs-6">
						    ...
						    <div class="form-group">
						    	<input type="text" class="form-control margin-bottom copy-input" name="customer_address_2" id="customer_address_2" placeholder="Address 2" tabindex="4" oninput="capitalizeInput('customer_address_2')" value="<?php echo $customer_address_2; ?>">
						    </div>
						    <div class="form-group">
						    	<input type="text" class="form-control margin-bottom copy-input required" name="customer_county" id="customer_county" placeholder="County" tabindex="6" oninput="capitalizeInput('customer_county')" value="<?php echo $customer_county; ?>">
						    </div>
						    <div class="form-group no-margin-bottom">
				...
				<div class="panel-body form-group form-group-sm">
					<div class="row">
						...
						<div class="col-xs-6">
						    ...
						    <div class="form-group no-margin-bottom">
						    	<input type="text" class="form-control required" name="customer_postcode_ship" id="customer_postcode_ship" placeholder="GST IN" tabindex="14" value="<?php echo $customer_postcode_ship; ?>">
							</div>
						</div>
					</div>
				</div>
	...
	<div class="row">
		<div class="col-xs-12 margin-top btn-group">
			<a href="customer-list.php" class="btn btn-success float-left">Back</a>
