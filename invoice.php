...
class invoicr extends FPDF_rotation 
{
	...
	*******************************************************************************/
    ...
    public $currency = 'RS.';
    public $maxImageDimensions = array(230, 130);
    public $language; // You might need to initialize this elsewhere
	...
	*******************************************************************************/
	function Header()
	{
		...
		if(!isset($this->productsEnded)) 
		{
			...
			$this->Cell($width_other,10,iconv("UTF-8", "ISO-8859-1",strtoupper('Qty')),0,0,'C',0);
			$this->Cell($this->columnSpacing,10,'',0,0,'L',0);
			$this->Cell($width_other,10,iconv("UTF-8", "ISO-8859-1",strtoupper('GST')),0,0,'C',0);
			$this->Cell($this->columnSpacing,10,'',0,0,'L',0);
